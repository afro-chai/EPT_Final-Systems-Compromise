...
**Your Kali VM:** **KALI5** (same as PWN2). Use this machine for scans, exploits, and listeners so teammates do not overwrite each other’s work.

**Your responsibilities:** **Written report** and the **team submission** for the report deliverable (LaTeX/Overleaf, PDF, Canvas—coordinate closely with **R_White**).

...
**Your Kali VM:** **KALI2** (same as PWN2). Use this machine for scans, exploits, and listeners so teammates do not overwrite each other’s work.

**Your responsibilities:** **Presentation** and the **team submission** for the presentation deliverable (slides, rehearsal, Canvas upload—coordinate closely with **J_Solis**).

...
Full command playbook: [`work/README.md`](work/README.md) → **`10.20.160.100`**. Evidence PNGs (**`100-001`…`100-007`**) are linked in the paragraphs above (same files under [`Screenshots/`](Screenshots/)).

...
**SAM hashes:** **`hashdump`** as **SYSTEM** — **[`100-007_meterpreter_hashdump_sam_tm6_afrocha.png`](Screenshots/100-007_meterpreter_hashdump_sam_tm6_afrocha.png)** (keep hash text out of markdown; screenshot is the evidence).
